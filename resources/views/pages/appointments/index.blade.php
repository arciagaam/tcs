<x-layout>
    ...
    <div class="flex gap-5">
        ...
        <div class="flex flex-col gap-5 w-1/4">
            ...
            {{-- <div class="flex flex-col gap-3 p-5 rounded-lg bg-slate-50 h-fit">
                <h2>Blue - Team Schedule</h2>
                <h2>Red - Appointments</h2>
            </div> --}}
                ...
                <div class="flex flex-col gap-5 p-5 rounded-lg bg-white shadow-sm h-fit">
                    ...
                    <form action="{{route('appointments.store')}}" method="POST" class="grid grid-cols-1 gap-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="group_code" name="group_code" placeholder="Enter group code" class="input" value="{{old('group_code')}}">
                            @error('group_code')
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="consultation_name" name="consultation_name" placeholder="Enter consultation name" class="input" value="{{old('consultation_name')}}">
                        ...
                        <div class="input-group">
                            ...
                            <input type="datetime-local" id="end_date" name="end_date" placeholder="Enter your last name" class="input" value="{{old('end_date')}}">
                            @error('end_date')
                                <p class="self-end text-xs text-red-400">{{$message}}</p>
                            @enderror
                        </div>
            ...
            <div class="flex flex-col gap-5 p-5 rounded-lg bg-white shadow-sm h-fit">
                ...
                <form action="{{route('appointments.store')}}" method="POST" class="grid grid-cols-1 gap-3" enctype="multipart/form-data">
                    @csrf
                    <div class="input-group">
                        <label for="group_code" class="label">Group Code</label>
                        <input type="text" id="group_code" name="group_code" placeholder="Enter group code" class="input" value="{{old('group_code')}}">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="email" name="email" placeholder="Enter consultation email" class="input" value="{{old('email')}}">
                        @error('email')
                            <p class="self-end text-xs text-red-400">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="input-group">
                        ...
                        <input type="text" id="remarks" name="remarks" placeholder="Enter consultation remarks" class="input" value="{{old('remarks')}}">
                        @error('remarks')
                            <p class="self-end text-xs text-red-400">{{$message}}</p>
                        @enderror
                    </div>
