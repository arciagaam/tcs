...
<body class="w-full h-screen">
    ...
    <div class="flex items-center justify-center w-full h-full">
        ...
        <div class="flex flex-col w-1/2 gap-5 p-14">
            ...
            <form action="{{route('forgot-password.post.step-two')}}" method="POST" class="flex flex-col gap-2">
                @csrf
                <div class="input-group">
                    <label for="code" class="label">Enter the code that was sent to your email.</label>
                    <div class="input">
                        <box-icon name='envelope'></box-icon>
                        <input type="text" id="code" name="code" placeholder="Enter code" class="w-full focus:outline-none">
                    </div>
                </div>

                <p class="text-xs italic self-end">NOTE: It might take a while. Check your spam.</p>
