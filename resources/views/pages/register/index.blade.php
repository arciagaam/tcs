...
<body class="w-full h-screen overflow-hidden">
    ...
    <div class="flex w-full h-full">
        ...
        <div class="flex flex-col w-1/2 gap-5 p-16 overflow-auto">
            ...
            <p class="text-sm">Already have an account? <a href="{{route('login')}}" class="underline text-primary-800">Log in here.</a></p>

            <form action="{{route('post.register')}}" method="POST" class="flex flex-col gap-5" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="year" name="year" class="input" value="{{old('year')}}">
                        @error('year')
                            <p class="self-end text-xs text-red-400">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="section" name="section" class="input" value="{{old('section')}}">
                        @error('section')
                            <p class="self-end text-xs text-red-400">{{$message}}</p>
                        @enderror
                    </div>
